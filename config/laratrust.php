...
return [
    ...
    */
    ...
    | If you want to use the teams feature that allows you to attach roles and permissions to
    |an user depending on a team, you must change the use_teams key value to true in your config/laratrust.php file. Then follow the Teams configuration guide
    |
    */
    'use_teams' => true,
